...
public class SQLHelper {
    ...
    */
        ...
        public static final String ID_APP = "_id";
    ...
    */
    ...
    public static final String ID_MAC_PREVIO = "_id";
    ...
    */
    ...
    public static final String ID_ANTECEDENTE = "_id";
    ...
    */
    ...
    public static final String ID_AREA_OPERATIVA = "_id";
    ...
    */
    ...
    public static final String ID_PARAJE = "_id";
    ...
    */
    ...
    public static final String ID_PACIENTE = "_id";
    ...
    */
    ...
    public static final String ID_CONTROL = "_id";
    ...
    public static final String CREAR_TABLA_CONTROLES = " CREATE TABLE " +
            NOMBRE_TABLA_CONTROLES+ " ("+
                ID_CONTROL +" INTEGER, "+
                EDAD_GESTACIONAL +" INTEGER NOT NULL, "+
                ECOGRAFIA + " VARCHAR NOT NULL, "+
                HPV + " BOOLEAN NOT NULL, "+
                PAP + " BOOLEAN NOT NULL, "+
                A_GRIPAL + " BOOLEAN NOT NULL, "+
                TBA_INMUNIZACION + " BOOLEAN NOT NULL, "+
                DB_INMUNIZACION + " VARCHAR NOT NULL, "+
                VHB_INMUNIZACION + " VARCHAR NOT NULL, "+
                CONTROL_CLINICO +" VARCHAR NOT NULL, "+
                TENSION_ARTERIAL + " FLOAT NOT NULL, "+
                OBSERVACIONES +" LONGVARCHAR, "+
                ID_PACIENTE_CONTROL_FK +" INTEGER NOT NULL, "+
    ...
    */ 
    ...
    public static final String ID_CONTROL_FK = "id_control_fk";

    public static final String CREAR_TABLA_SEROLOGIAS = " CREATE TABLE " +
            NOMBRE_TABLA_SEROLOGIAS+ " ("+
                ID_SEROLOGIA +" INTEGER, "+
                SIFILIS_SEROLOGIA +" VARCHAR NOT NULL, "+
                HIV_SEROLOGIA + " VARCHAR NOT NULL, "+
                CHAGAS_SEROLOGIA + " VARCHAR NOT NULL, "+
                VHB_SEROLOGIA + " VARCHAR NOT NULL, "+
                GAS_SEROLOGIA + " VARCHAR NOT NULL, "+
                HB_SEROLOGIA + " VARCHAR NOT NULL, "+
                GLUCEMIA + " VARCHAR NOT NULL, "+
                GRUPO_FACTOR_SEROLOGIA +" VARCHAR NOT NULL, "+
                ID_CONTROL_FK + " INTEGER NOT NULL, "+
                " CONSTRAINT "+ ID_SEROLOGIA +" PRIMARY KEY ("+ID_SEROLOGIA+"), "+
                " FOREIGN KEY ("+ID_CONTROL_FK+") REFERENCES "+NOMBRE_TABLA_CONTROLES+" ("+ID_CONTROL+")"+
            "); ";
